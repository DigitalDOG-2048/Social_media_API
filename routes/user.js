...
router.get('/get', auth, user.getAllUser);
router.post('/register', bodyParser(), validateUserRegister, user.register);
router.post('/login', bodyParser(), validateLogin, user.login)
